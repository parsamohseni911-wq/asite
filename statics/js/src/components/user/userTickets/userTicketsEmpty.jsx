// =============================================================================
// FILE: userTicketsEmpty.jsx
// =============================================================================
import React from 'react';
import { MessageSquare, RotateCcw } from 'react-feather';

const UserTicketsEmpty = ({ hasFilter }) => (
    <div className="bg-white dark:bg-[#111] rounded-2xl border border-gray-200 dark:border-gray-800 p-12 text-center">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">{hasFilter ? 'فیلتر را تغییر دهید.' : 'هنوز تیکتی ثبت نکرده‌اید.'}</p>
    </div>
);
