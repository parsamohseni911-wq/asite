...
const BrandFilterBar = ({ sortBy, onSortChange, viewMode, onViewModeChange, totalResults, showingResults }) => (
    ...
    <span className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">
      نمایش <span className="font-bold text-gray-900 dark:text-white">{showingResults?.toLocaleString('fa-IR')}</span> از{' '}
        <span className="font-bold text-gray-900 dark:text-white">{totalResults?.toLocaleString('fa-IR')}</span> محصول
    </span>
