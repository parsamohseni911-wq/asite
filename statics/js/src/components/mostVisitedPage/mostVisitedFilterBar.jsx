// =============================================================================
// mostVisitedFilterBar.jsx
// =============================================================================
import React from 'react';
import { Grid, List, TrendingUp } from 'react-feather';
import CustomSelect from '../common/customSelect/customSelect';

const sortOptions = [
    { value: 'visits', label: 'پربازدیدترین' },
    { value: 'cheapest', label: 'ارزان‌ترین' },
    { value: 'expensive', label: 'گران‌ترین' },
    { value: 'popular', label: 'محبوب‌ترین' },
];

const MostVisitedFilterBar = ({ sortBy, onSortChange, viewMode, onViewModeChange, totalResults }) => (
...
export default MostVisitedFilterBar;