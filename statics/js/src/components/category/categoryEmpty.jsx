// =============================================================================
// FILE: categoryEmpty.jsx (اصلاح‌شده - پشتیبانی از searchQuery)
// =============================================================================
import React from 'react';
import { Search, RotateCcw } from 'react-feather';

const CategoryEmpty = ({ searchQuery, onClear }) => (
    <div className="bg-white dark:bg-[#111] rounded-2xl border border-gray-200 dark:border-gray-800 p-12 text-center">
        ...
        <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">
            {searchQuery ? 'محصولی با این عنوان یافت نشد' : 'محصولی یافت نشد'}
        </h3>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
            {searchQuery ? `نتیجه‌ای برای "${searchQuery}" پیدا نشد.` : 'در این دسته‌بندی محصولی وجود ندارد.'}
        </p>
        {searchQuery && (
