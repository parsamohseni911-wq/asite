// =============================================================================
// FILE: guaranteeHero.jsx
// =============================================================================
import React from 'react';
import { Shield, Award, Clock, CheckCircle } from 'react-feather';
    ...
    <div className="relative mt-3 overflow-hidden rounded-2xl bg-gradient-to-br from-[#002874] via-[#003399] to-[#1a1a5e] p-6 sm:p-8 lg:p-10 mb-6">
        ...
        <div className="relative z-10 text-center">
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white mb-3">
                گارانتی <span className="text-amber-400">محصولات</span>
            </h1>
            <p className="text-sm sm:text-base text-white/70 max-w-2xl mx-auto leading-relaxed">
                تمامی محصولات شاپ مارکت دارای گارانتی معتبر هستند. ما کیفیت را تضمین می‌کنیم.
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-8 max-w-2xl mx-auto">
                {[
                    { icon: Award, label: 'ضمانت اصالت', text: 'کالای اصل' },
                    { icon: Clock, label: '۱۸ ماه', text: 'گارانتی طلایی' },
                    { icon: CheckCircle, label: 'تأیید کیفیت', text: 'توسط کارشناسان' },
                ].map((item, idx) => (
