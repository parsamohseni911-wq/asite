// =============================================================================
// FILE: sellerTicketsCard.jsx
// =============================================================================
import React from 'react';
import { Eye, MessageSquare, Clock, User } from 'react-feather';

const SellerTicketsCard = ({ ticket, statusMap, onView }) => {
            ...
            <div className="flex items-start justify-between gap-3">
                <div className="flex items-start gap-3 flex-1 min-w-0">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="text-xs text-gray-500 mt-0.5">{ticket.ticketCode} | <span className="flex items-center gap-1 inline-flex"><User size={10} />{ticket.customer}</span></p>
...
export default SellerTicketsCard;