// =============================================================================
// FILE: brandsStats.jsx
// =============================================================================
import React from 'react';
import { Award, Package, Grid, Zap } from 'react-feather';

const items = [
    { key: 'totalBrands', icon: Award, label: 'برند معتبر', gradient: 'from-blue-500 to-blue-600' },
    { key: 'totalProducts', icon: Package, label: 'محصول', gradient: 'from-emerald-500 to-green-600' },
    { key: 'totalCategories', icon: Grid, label: 'دسته‌بندی', gradient: 'from-violet-500 to-purple-600' },
    { key: 'activeBrands', icon: Zap, label: 'برند فعال', gradient: 'from-amber-500 to-orange-600' },
];

const BrandsStats = ({ stats = {} }) => (
