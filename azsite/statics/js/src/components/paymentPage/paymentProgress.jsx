// =============================================================================
// FILE: paymentProgress.jsx (هماهنگ با shippingProgress)
// =============================================================================
...
const PaymentProgress = ({ currentStep = 3 }) => (
    <div className="bg-white mt-3 dark:bg-[#111] rounded-2xl border border-gray-200 dark:border-gray-800 p-4 sm:p-6 mb-6">
